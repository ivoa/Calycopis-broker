...
implements DockerSimpleComputeResource
            ...
            public void process()
                ...
                try {
                    ...
                    if (this.containerId != null)
                        ...
                        nextPhase = LifecyclePhase.RUNNING;
                        }
                    else
                        {
                        nextPhase = LifecyclePhase.FAILED;
    ...
    public ProcessingAction getMonitorAction(final Platform platform, final ComponentProcessingRequest request)
        ...
        return new ComponentProcessingAction()
            {
            private LifecyclePhase nextPhase = LifecyclePhase.RUNNING;
            ...
            public void process()
                ...
                try {
                    ...
                    if (dockerClient == null)
                        ...
                        this.nextPhase = LifecyclePhase.FAILED;
                        return ;
                        }
                    ...
                    if (Boolean.TRUE.equals(state.getRunning()))
                        {
                        this.nextPhase = LifecyclePhase.RUNNING;
                        }
                    else {
                        ...
                        if (this.exitCode != null && this.exitCode == 0)
                            {
                            this.nextPhase = LifecyclePhase.RELEASING;
                            }
                        else {
                            log.warn(
