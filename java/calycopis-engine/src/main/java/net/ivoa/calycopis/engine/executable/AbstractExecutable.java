...
package net.ivoa.calycopis.engine.executable;

import net.ivoa.calycopis.engine.lifecycle.LifecycleComponent;

/**
 * Framework-independent interface for an executable.
 *
 * This is the engine-layer replacement for the broker's
 * {@code net.ivoa.calycopis.datamodel.executable.AbstractExecutable}.
