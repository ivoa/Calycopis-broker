...
package net.ivoa.calycopis.engine.storage;

import net.ivoa.calycopis.engine.lifecycle.LifecycleComponent;

/**
 * Framework-independent interface for a storage resource.
 *
 * This is the engine-layer replacement for the broker's
 * {@code net.ivoa.calycopis.datamodel.storage.AbstractStorageResource}.
