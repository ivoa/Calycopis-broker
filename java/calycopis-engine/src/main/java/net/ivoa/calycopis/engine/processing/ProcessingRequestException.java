...
/**
 * Checked exception thrown when a processing request cannot be completed.
 *
 * This is the engine-layer replacement for the broker's
 * {@code net.ivoa.calycopis.functional.processing.ProcessingRequestException} class.
 */
public class ProcessingRequestException
extends Exception
    {
