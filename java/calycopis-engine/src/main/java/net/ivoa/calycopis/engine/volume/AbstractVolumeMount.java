...
package net.ivoa.calycopis.engine.volume;

import net.ivoa.calycopis.engine.component.Component;

/**
 * Framework-independent interface for a volume mount.
 *
 * This is the engine-layer replacement for the broker's
 * {@code net.ivoa.calycopis.datamodel.volume.AbstractVolumeMount}.
