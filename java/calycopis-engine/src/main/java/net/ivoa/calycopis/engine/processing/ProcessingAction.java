 ...
 * {@code net.ivoa.calycopis.functional.processing.ProcessingAction} interface.
...
public interface ProcessingAction
    ...
    /**
     * A no-op action singleton that can be returned when no external action is needed.
     *
     */
