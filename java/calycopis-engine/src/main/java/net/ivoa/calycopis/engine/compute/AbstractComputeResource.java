...
package net.ivoa.calycopis.engine.compute;

import net.ivoa.calycopis.engine.lifecycle.LifecycleComponent;

/**
 * Framework-independent interface for a compute resource.
 *
 * This is the engine-layer replacement for the broker's
 * {@code net.ivoa.calycopis.datamodel.compute.AbstractComputeResource}.
